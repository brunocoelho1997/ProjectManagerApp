...
namespace ProjectManagerApp2.Controllers.RolesController
{
    ...
    public class RolesController : BaseController
    {
        ...
        public async Task<IHttpActionResult> GetRole(string Id)
        {
            ...
            if (role != null)
            {
                return Ok(RoleDTOFactory.Create(role));
            }
        ...
        [Route("create")]
        public async Task<IHttpActionResult> Create(CreateRoleBindingDTO model)
        {
            ...
            return Created(locationHeader, RoleDTOFactory.Create(role));
